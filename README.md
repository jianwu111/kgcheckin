...
2. 将上一步复制的令牌设置为仓库的环境变量

   - <img width="2503" height="1332" alt="image" src="https://github.com/user-attachments/assets/9eff9770-cc93-451e-b6f0-ce058489680b" />
   - Name *：PAT
   - Secret *：上一步复制的令牌
...
1. 默认未启用。启用 Actions `main` , 每天北京时间 00:01 自动签到
